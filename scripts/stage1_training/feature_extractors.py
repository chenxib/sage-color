...
from scripts.stage1_training.cleandift_min_sd21 import SD21UNetModel
...
class SD21UNetFeatureExtractor(SD21UNetModel):
    ...
    notebook helper while keeping stage-1 self-contained.
    """
...
class CleanDIFTFeatureExtractor:
    """CleanDIFT SD2.1 feature extractor for stage-1 dense correspondence.
