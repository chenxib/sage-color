...
from scripts.stage1_training.corr_state import cache_path_for_index, load_corr_npz
        ...
        if self.load_corr_cache:
            ...
            if not cache_path.exists():
                raise FileNotFoundError(
                    f"Missing correspondence cache for row {index}: {cache_path}. "
                    "Run scripts/stage1_training/build_corr_cache.py first."
                )
