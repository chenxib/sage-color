...
# Optional offline cache builder for full stage-1 model.
...
# SigLIP2, matching full stage-1 model correspondence.
...
OUTPUT_DIR="${OUTPUT_DIR:-datasets/corr_cache_stage1_1024}"
...
cmd=(
  "${PYTHON_BIN}" scripts/stage1_training/build_corr_cache.py
