...
from scripts.final_model.corr_state import cache_path_for_index, save_corr_npz
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=str, default="datasets/corr_cache_final_1024")
